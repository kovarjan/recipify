...
<img src="docs/img/icon.png" alt="Recipify Logo" width="180" height="180" style="border-radius: 20px; " />
</a>
...
* [<img src="https://img.shields.io/badge/React_Native-20232A?style=for-the-badge&logo=react&logoColor=61DAFB" alt="React Native" style="height: 25px; vertical-align: middle;" />][ReactNative-url]
* [<img src="https://img.shields.io/badge/Expo-20232A?style=for-the-badge&logo=expo&logoColor=1B1F23" alt="Expo" style="height: 25px; vertical-align: middle;" />][Expo-url]
* [<img src="https://img.shields.io/badge/TypeScript-20232A?style=for-the-badge&logo=typescript&logoColor=3178C6" alt="TypeScript" style="height: 25px; vertical-align: middle;" />][TypeScript-url]
* [<img src="https://img.shields.io/badge/SQLite-20232A?style=for-the-badge&logo=sqlite&logoColor=003B57" alt="SQLite" style="height: 25px; vertical-align: middle;" />][SQLite-url]
* [<img src="https://img.shields.io/badge/OpenAI-20232A?style=for-the-badge&logo=openai&logoColor=412991" alt="OpenAI" style="height: 25px; vertical-align: middle;" />][OpenAI-url]

<br />
<img src="docs/img/recipify_flow_graphics.png" alt="Tech Stack" style="max-width: 100%; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);" />
...
ios/               # Native iOS project (auto-generated by Expo)
app/               # Expo Router: File-based navigation & screens
    (tabs)/            # Tabbed navigation (import, recipes, search, settings)
    recipe/            # Recipe detail and edit screens
assets/            # Images, icons, fonts, and splash screens
components/        # Reusable UI components (Button, RecipeCard, etc.)
contexts/          # React context providers (e.g., SearchContext)
docs/              # Documentation and app screenshots
lib/               # Database schema, seeders, and helpers
services/          # API wrappers (OpenRouter, OCR, LLM, etc.)
...
[contributors-shield]: https://img.shields.io/github/contributors/kovarjan/recipify.svg?style=for-the-badge
[contributors-url]: https://github.com/kovarjan/recipify/graphs/contributors
[forks-shield]: https://img.shields.io/github/forks/kovarjan/recipify.svg?style=for-the-badge
[forks-url]: https://github.com/kovarjan/recipify/network/members
[stars-shield]: https://img.shields.io/github/stars/kovarjan/recipify.svg?style=for-the-badge
[stars-url]: https://github.com/kovarjan/recipify/stargazers
[issues-shield]: https://img.shields.io/github/issues/kovarjan/recipify.svg?style=for-the-badge
[issues-url]: https://github.com/kovarjan/recipify/issues
[license-shield]: https://img.shields.io/github/license/kovarjan/recipify.svg?style=for-the-badge
